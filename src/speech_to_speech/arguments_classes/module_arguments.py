...
class ModuleArguments:
    ...
    stt: Optional[
        ...
        metadata={
            "help": "The STT to use. Either 'whisper', 'whisper-mlx', 'mlx-audio-whisper', 'faster-whisper', 'parakeet-tdt', 'paraformer', 'lemonfox', 'openrouter-parakeet', or 'elevenlabs-realtime'. Default is 'parakeet-tdt'."
        },
    )
    llm_backend: Optional[Literal["transformers", "mlx-lm", "responses-api", "chat-completions", "companion-runtime"]] = field(
        default="companion-runtime",
        metadata={
            "help": "The LLM backend to use. Either 'transformers', 'mlx-lm', 'responses-api', "
            "'chat-completions' (OpenAI-compatible /v1/chat/completions), or 'companion-runtime' "
            "(delegate turns to the companion-runtime brain). Default is 'companion-runtime'."
        },
    )
    tts: Optional[Literal["chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "lemonfox"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', or 'lemonfox'. Default is 'qwen3'."
        },
    )
    log_level: str = field(
        default="info",
